    ...
    <main>
      ...
      <section>
        <div className='flex justify-between'>
          ...
          <label htmlFor='add-address' className={`${styles.bgprimary} cursor-pointer rounded-xl pl-5 pr-5 flex justify-center items-center text-white`}>
            Add
          </label>
        </div>
        <Separator />
      ...
      <section>
        ...
        <Separator />
          ...
          <div className='w-full flex flex-col items-center'>
            ...
            <label htmlFor='add-payment' className={`${styles.bgprimary} cursor-pointer rounded-xl pl-5 pr-5 flex justify-center items-center text-white`}>
              Add
            </label>
          </div>}
      </section>
