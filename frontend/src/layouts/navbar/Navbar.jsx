...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <a className="btn btn-ghost normal-case text-xl font-black text-base-100" href='./products'>JungleCart</a>
  </div>

  
  <div className="navbar-center hidden lg:flex">
  <div className="form-control w-[600px]  h-full">
      <input type="text"  className="input  border-base-200  bg-base-100  rounded-xl border" 
