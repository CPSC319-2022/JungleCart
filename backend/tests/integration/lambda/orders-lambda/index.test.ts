...
import * as data from 'tests/events/orders/pending_order_2.json';
import * as data2 from 'tests/events/orders/get_orders.json';
import * as data3 from 'tests/events/orders/updated_order.json';
import * as data4 from 'tests/events/orders/delete_order.json';
